...
public record ProductResponse(Integer id,String name, String aditumId, String brand,String imgUrl,  ProductType type, Double value, Status status, Establishment establishment){}
