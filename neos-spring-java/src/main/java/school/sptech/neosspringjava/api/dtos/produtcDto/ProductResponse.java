...
public record ProductResponse( String aditumId, Integer id,String name, String brand,String imgUrl,  ProductType type, Double value, Status status, Establishment establishment){}
