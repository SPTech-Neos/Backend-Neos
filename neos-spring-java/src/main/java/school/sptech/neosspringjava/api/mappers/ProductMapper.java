...
public class ProductMapper {
    ...
    public static ProductResponse toProductResponse(Product product) {
        return new ProductResponse(product.getAditumId(), product.getId(), product.getName(), product.getBrand(), product.getImgUrl(), product.getType(), product.getPrice(), product.getStatus(), product.getEstablishment());
    }
